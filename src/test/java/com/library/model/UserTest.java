...
// Action 2: Imports reordered — static imports first, then org.*,
...
class UserTest {
  ...
  void shouldGenerateUniqueIds() {
    ...
    User user2 = new User("B", "b@test.com",
        UserRole.REQUESTER);
  ...
  void shouldUpdateName() {
    User user = new User("Old", "email@test.com",
        UserRole.ADMIN);
    user.setName("New");
  ...
  void shouldUpdateEmail() {
    User user = new User("Name", "old@test.com",
        UserRole.ADMIN);
  ...
  void shouldReturnFalseForRequesterRoleCheck() {
    User requester = new User("Requester", "req@test.com",
        UserRole.REQUESTER);
