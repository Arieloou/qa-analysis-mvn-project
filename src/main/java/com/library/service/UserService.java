...
public class UserService {
   ...
   * @throws IllegalArgumentException if user is null, already exists,
   *     or email is duplicated
   */
  public void addUser(User user) {
    ...
    // Action 3: Line length fix — split the long exception message across lines
